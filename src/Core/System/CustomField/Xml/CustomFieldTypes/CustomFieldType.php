 ...
 * @internal
 *
 * @phpstan-type CustomFieldTypeArray array{name?: string, type?: string, config: array{label: array<string, string>, helpText: array<string, string>, customFieldPosition: int, validation?: 'required'}, allowCustomerWrite?: true, allowCartExpose?: true, includeInSearch?: true, translatable?: bool}
 */
#[Package('framework')]
abstract class CustomFieldType extends XmlElement
{
    ...
    public function toEntityPayload(): array
    {
        ...
        if ($this->translatable !== null) {
            $entityArray['translatable'] = $this->translatable;
        }
